                            ...
                            return InkWell(
                                onTap: () {
                                  ...
                                  Get.to(() => SecondPage(
                                      ...
                                      dayIndex:index,
                                    feelsLike:
                                  weatherController.singleRead[index].main.feelsLike,
                                  humidity:weatherController.singleRead[index].main.humidity,
                                  wind:weatherController.singleRead[index].wind.speed));
                                  print(index);
                                },
                                child: SizedBox(
                                  height: 100,
